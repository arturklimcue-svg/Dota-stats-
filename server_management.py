...
COMMUNITY_TEXT_CHANNELS = ["👋-приветствия", "💬-общий-чат", "🖼-скриншоты", "🎬-клипы-и-фейлы", "😂-мемы", "🎉-ивенты"]

GAME_CATEGORY = "🎮 Игровая"
LFG_CHANNEL = "🔍-лфг"
GAME_TEXT_CHANNELS = [LFG_CHANNEL, "🟢-кто-в-игре", "🏆-лидерборд", "🛒-трейд-предметов",
                      "🧠-советы-и-стратегии", "🐲-бестиарий-героев"]
...
READ_ONLY_CHANNELS = ["🧠-советы-и-стратегии", "🏆-лидерборд", STATUS_BOARD_CHANNEL]
...
class ServerManagement(commands.Cog):
    ...
    async def server_setup(self, ctx: commands.Context):
        ...
        await ctx.send(
            "Готово: тематические категории, ранговые каналы, доска \"кто в игре\", "
            "лидерборд, ролл героя, роль уведомлений, закреплённые справки, join-to-create "
            "и verification настроены.")
